...
@pytest.mark.parametrize('args, expected_args', [(['--api-key', API_KEY, '--log-level', 'DEBUG', '--base-url', BASE_URL, 'rig', 'list'], 
                                                 ...
                                                 Namespace(help=False, log_level='INFO', prettify=False, handler='rig_tarrifs', id=None, api_key=API_KEY, base_url=DEFAULT_BASE_URL)), 
                                                 (['--api-key', API_KEY, 'rig', 'tariffs', '--id', RIG_ID], 
                                                 Namespace(help=False, log_level='INFO', prettify=False, handler='rig_tarrifs', id=RIG_ID, api_key=API_KEY, base_url=DEFAULT_BASE_URL)), 
